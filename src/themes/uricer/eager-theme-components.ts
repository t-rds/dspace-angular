...
import { ProgramItemMetadataListElementComponent } from './app/entity-groups/research-entities/metadata-representations/program/program-item-metadata-list-element.component';
...
export const COMPONENTS = [
  ...
  ProgramItemMetadataListElementComponent,
