...
import { UndergraduateProgramComponent } from './app/entity-groups/research-entities/item-pages/undergraduate-program/undergraduate-program.component';
